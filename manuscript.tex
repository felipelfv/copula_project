...
The scatter plots in the Appendix display Spearman's \(\rho\) and
Kendall's \(\tau\) for both the marginal pair \((X,Y)\) and the partial
copula pair \((U_X, U_Y)\) across all scenarios. The results confirm the
...
{\centering \includegraphics[width=1\linewidth]{manuscript_files/figure-latex/scatter-1-1} 

}

\caption{Scenario 1 (see Table 1). Each row corresponds to a copula family and parameter triplet $(\theta_{XZ}, \theta_{YZ}, \theta_{XY|Z})$. Each panel displays $\rho$ (Spearman) and $\tau$ (Kendall). Color gradient represents $Z$.}\label{fig:scatter-1}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{manuscript_files/figure-latex/scatter-2-1} 

}

\caption{Scenario 2 (see Table 1). Each row corresponds to a copula family and parameter triplet $(\theta_{XZ}, \theta_{YZ}, \theta_{XY|Z})$, where ind denotes independence.}\label{fig:scatter-2}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{manuscript_files/figure-latex/scatter-3-1} 

}

\caption{Scenario 3 (see Table 1). Each row corresponds to a copula family and parameter triplet $(\theta_{XZ}, \theta_{YZ}, \theta_{XY|Z})$, where ind denotes independence. (R) indicates 90-degree rotation.}\label{fig:scatter-3}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{manuscript_files/figure-latex/scatter-4-1} 

}

\caption{Scenario 4 (see Table 1). Each row corresponds to a copula family and parameter triplet $(\theta_{XZ}, \theta_{YZ}, \theta_{XY|Z})$, where ind denotes independence.}\label{fig:scatter-4}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{manuscript_files/figure-latex/scatter-5-1} 

}

\caption{Scenario 5 (see Table 1). Each row corresponds to a copula family and parameter triplet $(\theta_{XZ}, \theta_{YZ}, \theta_{XY|Z})$.}\label{fig:scatter-5}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{manuscript_files/figure-latex/scatter-6-1} 

}

\caption{Scenario 6 (see Table 1). Each row corresponds to a copula family and parameter triplet $(\theta_{XZ}, \theta_{YZ}, \theta_{XY|Z})$. (R) indicates 90-degree rotation.}\label{fig:scatter-6}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{manuscript_files/figure-latex/scatter-7-1} 

}

\caption{Scenario 7 (see Table 1). Each row corresponds to a copula family and parameter triplet $(\theta_{XZ}, \theta_{YZ}, \theta_{XY|Z})$. (R) indicates 90-degree rotation.}\label{fig:scatter-7}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{manuscript_files/figure-latex/scatter-8-1} 

}

\caption{Scenario 8 (see Table 1). Each row corresponds to a copula family and parameter triplet $(\theta_{XZ}, \theta_{YZ}, \theta_{XY|Z})$.}\label{fig:scatter-8}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{manuscript_files/figure-latex/scatter-9-1} 

}

\caption{Scenario 9 (see Table 1). Each row corresponds to a copula family and parameter triplet $(\theta_{XZ}, \theta_{YZ}, \theta_{XY|Z})$.}\label{fig:scatter-9}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{manuscript_files/figure-latex/scatter-10-1} 

}

\caption{Scenario 10 (see Table 1). Each row corresponds to a copula family and parameter triplet $(\theta_{XZ}, \theta_{YZ}, \theta_{XY|Z})$, where ind denotes independence.}\label{fig:scatter-10}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{manuscript_files/figure-latex/scatter-11-1} 

}

\caption{Scenario 11 (see Table 1). Simplifying assumption violated. The conditional copula parameter $\theta(z)$ varies with $Z$.}\label{fig:scatter-11}
\end{figure}
...
partial copulas: bounds and new insights}
\author{Vinícius Litvinoff Justus (Carlos III University of Madrid,
Spain) \and Felipe Fontana Vieira (Ghent University, Belgium)}
\date{March 2026}
...
causal inference was considered by \citet{justus2024} and
\citet{czado2025} - however, to the best of our knowledge, the use of
partial copulas to investigate causal effects is not yet properly explored
in the literature.
...
estimation of partial copulas from real data is of great interest for
the scientific community, since it would allow to apply the insights of
this paper in empirical contexts.
